...
**Status:** Inspection complete — three remediations verified; one active
...
| [`MG-SEC-004`](findings/MG-SEC-004.md) | Internet-facing service runs with passwordless root authority | High | High | systemd and EC2 account boundary | In remediation |
