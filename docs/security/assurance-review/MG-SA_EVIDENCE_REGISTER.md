...
| `MG-SA-E-022` | GitHub | Exact remediation commit workflow runs | Secret Scan run `34809206809`, job `103866966275`, and Dependency Security run `34809206835`, job `103866966991`, completed successfully on attempt one; substantive steps were not skipped | Successful commit evidence; `MG-SA-002` enforcement limitation remains |
