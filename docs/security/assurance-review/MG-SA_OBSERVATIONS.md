...
|---|---|---|---|---|
| `MG-SA-O-001` | Resource containment | Mounted graph/intelligence routes are absent from admission and deadline classification, and the documented Nginx site-wide connection cap is client-keyed | **Implementation defect** | Confirmed as `MG-SA-001` |
...
| `MG-SA-O-007` | Source governance | Commits are unsigned and `main` permits direct/force updates | **Accepted residual risk** | Solo-maintainer public prototype; CI enforcement aspect is separately qualified by `MG-SA-002` |
