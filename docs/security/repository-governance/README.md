...
| --- | --- | --- |
| [`MG-GOV-001`](MG-GOV-001.md) | Protect `main`, require pull requests and security checks, enable GitHub security services, and establish public policy files | In progress |
