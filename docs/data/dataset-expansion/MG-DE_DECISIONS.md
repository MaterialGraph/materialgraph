...
| MG-DE-D-014 | Preserve all 48 chemical systems and reduce the MG-DE-005 energy-above-hull ceiling to 0.05 eV/atom | Offline sensitivity retained 1,455 of the truncated 3,000 records, leaving material-count headroom for the 15 unvisited Na systems without weakening completeness or database-write gates | Approved for controlled re-execution |
